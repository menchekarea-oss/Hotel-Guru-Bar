...
2. Double-click `RUN_LOCAL_V13.bat`.
...
6. The app opens with a visible `v13` badge.

The terminal must show:

`HOTEL GURU BILLING BUILD 13.0.0 — LOCAL NO-CACHE DEVELOPMENT SERVER`
...
- Visible app badge: `v13`
- `http://localhost:8091/VERSION.txt`
- `http://localhost:8091/sw.js` contains `hotel-guru-billing-app-v13`
- Response header: `X-Hotel-Guru-Billing-Build: 13.0.0`
